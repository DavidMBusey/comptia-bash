...
["ATT&CK"]="Adversarial Tactics, Techniques,"
...
echo "Select acronym or written name"
echo "1. Acronyms"
echo "2. Fully Written name"
read badInputMethod

if [[ $badInputMethod == 1 ]]; then
	let random=$((1 + $RANDOM % ${#arr[@]}))
	echo $random
	echo ${!arr[@]}
	for key in ${!arr[@]}; do
		echo
